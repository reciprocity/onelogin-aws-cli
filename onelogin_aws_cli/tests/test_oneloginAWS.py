...
class TestOneloginAWS(TestCase):
    ...
    def test_get_arns(self):
        ...
        self.assertEqual([(self.ROLE_PREFIX, self.PRVD_PREFIX)], self.ol.all_roles)
    ...
    def test_get_arns_multi(self):
        ...
        self.assertEqual(
            (self.ROLE_PREFIX + "0", self.PRVD_PREFIX + "0"), self.ol.all_roles[0]
        )
        self.assertEqual(
            (self.ROLE_PREFIX + "1", self.PRVD_PREFIX + "1"), self.ol.all_roles[1]
        )
        self.assertEqual(
            (self.ROLE_PREFIX + "2", self.PRVD_PREFIX + "1"), self.ol.all_roles[2]
        )
    ...
    def test__initialize_credentials(self):
        with patch(
            "os.path.expanduser", side_effect=["/home/.aws/credentials", "/home/.aws/"]
        ):
